...
class ReadGun1DCMeterInfoActivity : SerialPortBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "Gun1 DC Meter Information"

        gunsDCMeterListAdapter = GunsDCMeterListAdapter {}

        binding.apply {
            rvAcMeterInfo.layoutManager = LinearLayoutManager(this@ReadGun1DCMeterInfoActivity)
